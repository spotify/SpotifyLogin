...
public class SpotifyLogin {
    ...
    public func configure(clientID: String, clientSecret: String, redirectURL: URL, showDialog: Bool?) {
        self.clientID = clientID
        self.clientSecret = clientSecret
        self.redirectURL = redirectURL
        self.urlBuilder = URLBuilder(clientID: clientID, clientSecret: clientSecret, redirectURL: redirectURL, showDialog: showDialog ?? true)
    }
